...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection taggables_id
     * @property Grid\Column|Collection taggables_type
     ...
     * @method Grid\Column|Collection taggables_id(string $label = null)
     * @method Grid\Column|Collection taggables_type(string $label = null)
     ...
     * @property Show\Field|Collection taggables_id
     * @property Show\Field|Collection taggables_type
     ...
     * @method Show\Field|Collection taggables_id(string $label = null)
     * @method Show\Field|Collection taggables_type(string $label = null)
